...
import { SpaceshipMotionComponent, SpaceshipAttackComponent, DisplayObjectComponent, RocketBehaviorComponent, CircleColliderComponent, AsteroidBehaviorComponent, BlastSetupComponent, GameFieldComponent, GameFieldBehaviourComponent } from '../components';
...
export default class CustomGameSession extends GameSession {
    ...
    _createGameField() {
        ...
        let components = [
            new DisplayObjectComponent(container, this.screen),
            new GameFieldBehaviourComponent(),
            new GameFieldComponent()
        ];
    ...
    _initSetup() {
        let setupComponent = new BlastSetupComponent(this.screen, this.#layout);
